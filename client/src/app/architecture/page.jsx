    ...
    <AppShell>
      <div className="space-y-6">
        ...
        <section className="grid gap-4 md:grid-cols-3">
          {areas.map(area => (
            <div key={area} className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-4">
              <div className="text-sm font-semibold text-mint">{area}</div>
            </div>
          ))}
        </section>

        <section className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5">
          <h2 className="text-xl font-semibold text-[var(--text)]">System shape</h2>
          <div className="mt-4 grid gap-3 md:grid-cols-2">
            {blocks.map(([title, body]) => (
              <div key={title} className="rounded-2xl border border-[var(--border)] bg-[var(--surface2)] p-4">
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5">
            <h2 className="text-xl font-semibold text-[var(--text)]">Reliability choices</h2>
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5">
            <h2 className="text-xl font-semibold text-[var(--text)]">Future scaling</h2>
            <ul className="mt-3 space-y-2 text-sm text-[var(--muted)]">
