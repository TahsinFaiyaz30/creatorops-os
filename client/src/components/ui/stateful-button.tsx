...
export const Button = ({ className, children, ...props }: ButtonProps) => {
  ...
  /** Hide the spinner without claiming success — used when onClick rejects. */
  ...
  const handleClick = async (event: React.MouseEvent<HTMLButtonElement>) => {
    ...
    // Upstream awaits onClick unguarded, so a rejected handler both skipped the
    // reset (spinner spins forever) and escaped as an unhandled rejection. A
    // failed action must not play the success checkmark.
    try {
